/*!
 * jQuery Plug-in: sprintf
 */
/**
 * sprintf and vsprintf for jQuery somewhat based on
 * http://jan.moesen.nu/code/javascript/sprintf-and-printf-in-javascript/
 * 
 * Copyright (c) 2008 Sabin Iacob (m0n5t3r) <iacobs@m0n5t3r.info> This program
...
(function($) {
	...
	var dispatch = function(data) {
		if (data.length == 1 && typeof data[0] == 'object') { // python-style
			// printf
			data = data[0];
