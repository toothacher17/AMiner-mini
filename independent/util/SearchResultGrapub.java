...
public class SearchResultGrapub{
	...
	public static List<String> getRandomQueryList(List<String> wordMap, Integer queryListNum){
		...
		for(int i = 0 ; i < queryListNum ; i ++){
			randomNum.add((int)(Math.random()*32000));
		}
	...
	public static void main(String [] args){
		String fileInWordmap = "D:\\Users\\jingyuanliu\\data\\finalProbaResult\\result1026\\grapub\\ldalmsearch\\wordmap.txt";
		String fileInRemainedDoc = "D:\\Users\\jingyuanliu\\data\\finalProbaResult\\result1026\\grapub\\ldalmsearch\\remainedGrapubDocNoTest.txt";
		String fileInMatrix = "D:\\Users\\jingyuanliu\\workspaceformatlab\\grapub1026\\grapubldalmresult.txt";
		String fileInDoc = "D:\\Users\\jingyuanliu\\data\\finalProbaResult\\result1026\\grapub\\ldalmsearch\\grapub.txt";
		String fileOut = "D:\\Users\\jingyuanliu\\data\\finalProbaResult\\result1026\\grapub\\ldalmsearch";
		Map<String,Integer> wordMap = SearchResultGrapub.loadWordMap(fileInWordmap);
//		List<String> wordMapList = new ArrayList<String>(wordMap.keySet());

//		List<String> randomQueryList = SearchResultGrapub.getRandomQueryList(wordMapList, 10);
		
		List<String> manualQueryList = SearchResultGrapub.manualMakeQueryList();
		
		List<List<Double>> matrix = loadResultMatrix(fileInMatrix); 
		
		Map<Integer,Integer> remainedDoc = SearchResultGrapub.getRemainedDoc(fileInRemainedDoc) ;
		
		Map<Integer, String> outputDoc = SearchResultGrapub.getRealDoc(fileInDoc);
		
		File f = new File(fileOut,"TestLDALMResul3Manual.txt");
		try{
			...
			for(String tempQuery : manualQueryList){
				...
				List<Integer> getTheTop5RelatedDoc = SearchResultGrapub.findTheBiggestColum(getWordLineInMatrix);
