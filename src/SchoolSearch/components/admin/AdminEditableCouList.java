...
public class AdminEditableCouList {
	...
	@Property
	List<SchooltestCourse> _courseList;

	@Property
	List<SchooltestPerson2course> person2courseList;

	@Property
	SchooltestCourse _course;
...
//			_publicationList = publicationService.getPublicationsByPersonId(_personId);
			_courseList = courseService.getRelatedCourseList(_personId);
			System.out.println("this is the test of whether the system is working " + _courseList.size());
...
//				Collections.sort(_publicationList, Collections.reverseOrder(SchooltestPublication.defaultComparator));
				Collections.sort(_courseList, Collections.reverseOrder(new ComparatorUtil.GeneralComparator<SchooltestCourse>(SchooltestCourse.class, "semesterId")));
			}
//		} else {
...
//	}
	...
	public Integer getCourseListSize() {
		return _courseList.size();
	}
...
//	}
	...
	public Integer getLineNumber() {
		return _courseList.size() - index;
	}

//	public String getPublicationBorderClass() {
//		if (_publicatin.getType().equals("conf")) {
//			return "borderConf";
//		} else {
...
//	}
	...
	public List<String> getAllSemesternameList() {
		...
		String[] temp = _course.getSemesterName().split("\\|\\|");
 		for (String t : temp) {
 			result.add(t);
 		}
		return result;
	...
	public Object onDeleteCourse(EventContext context) {
