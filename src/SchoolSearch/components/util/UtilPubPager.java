...
public class UtilPubPager {
	...
	Object onSwitchToPrePage(EventContext context) {
		...
		_currentPage--;
		parent.anotherPrepareData(this.totalPage, _currentPage,_publicationIdList,_personId);
...
//		parent.prepareData(nContext, _currentPage);
		parent.anotherPrepareData(this.totalPage, _currentPage,_publicationIdList,_personId);
//		parent.anotherPrepareData(this.totalPage, _currentPage);
		return parent.getPagerRefreshZoneBody();
	}
